...
Shared audit runner logic for product repositories that want one local entrypoint for multiple scanners without duplicating Docker, reporting, and CLI wiring.
...
- Sonar scanner orchestration through `shared-sonar`
...
2. add `Guidelines/shared-audits` to `sys.path`
3. import `shared_audits`
